...
contract SwimToken is BEP20, Ownable {
    using SafeMath for uint;

    address public constant CHARITY_WALLET = 0x3B6FEEF40E2F2cDb7a1766AdF2E9e0bBD101147D; //Ganache test address index 1
    address public constant ADMIN_WALLET = 0x93ec633ef65Ef31A32C187ddE3329Fbc0D4A4018; // Ganache test account index 2
    ...
    bool private isBurnEventOver = true; // once burn event is over, this value will be set to true and tax on each tx will start
    ...
    constructor() BEP20("SwimToken", "SWIM") {
        _mint(ADMIN_WALLET, TOTAL_SUPPLY.mul(10**decimals()).mul(10000).div(PERCENTAGE_MULTIPLIER)); // 100% to ADMIN_WALLET
